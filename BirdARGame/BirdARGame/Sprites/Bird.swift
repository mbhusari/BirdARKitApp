...
class Bird : SKSpriteNode {
    ...
    func setup() {
        ...
        let texturedAtlas = SKTextureAtlas(named: "bird")
        let frames = ["sprite_0", "sprite_1", "sprite_2", "sprite_3", "sprite_4", "sprite_5", "sprite_6"].map{texturedAtlas.textureNamed($0)}
        ...
        let removeBird = SKAction.run {
            NotificationCenter.default.post(name: NSNotification.Name("Spawn"), object: nil)
